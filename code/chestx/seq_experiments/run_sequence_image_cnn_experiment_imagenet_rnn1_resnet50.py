...
print('Loading data...')
train_df = pd.read_pickle(data_output_dir + 'train_{0}/train_{0}_balanced_uncollapsed.pkl'.format(sample_size))
...
print('Train features shape: {}'.format(train_image_features.shape))
...
model_output_dir = dir + 'trained_models/chestx/image_rnn_{}/train_{}/{}/{}_{}_{}'\
